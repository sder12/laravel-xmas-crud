            ...
            <form action="{{ route('letters.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text"class="form-control @error('present') is-invalid @enderror" id="present"
                        name="present" value="{{ old('present') }}">
                    {{-- ERROR msg --}}
                    @error('present')
                        <div class="invalid-feedback">
                            {{ $message }}
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="letter_text" rows="3" name="letter_text">  {{ old('letter_text') }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control @error('goodness_rating')  is-invalid @enderror" id="goodness_rating"
                        ...
                        <option value="1" @selected(old('goodness_rating') == '1')>1</option>
                        <option value="2" @selected(old('goodness_rating') == '2')>2</option>
                        <option value="3" @selected(old('goodness_rating') == '3')>3</option>
                        <option value="4" @selected(old('goodness_rating') == '4')>4</option>
                        <option value="5" @selected(old('goodness_rating') == '5')>5</option>
                    </select>
                    {{-- ERROR msg --}}
